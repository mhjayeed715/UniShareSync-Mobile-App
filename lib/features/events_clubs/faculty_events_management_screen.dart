...
class FacultyEventsManagementScreen extends StatefulWidget {
  const FacultyEventsManagementScreen({super.key});

  @override
  State<FacultyEventsManagementScreen> createState() => _FacultyEventsManagementScreenState();
}

class _FacultyEventsManagementScreenState extends State<FacultyEventsManagementScreen> {
  ...
  Future<void> _loadEvents() async {
    ...
    try {
      ...
      final allEvents = await _eventsService.searchEvents(
      ...
      if (_selectedStatus != null) {
        myEvents = myEvents.where((e) => e.status == _selectedStatus).toList();
      }
